                      ...
                      <Link href={`/resources/${resource.id}`}>
                        ...
                        >
                          <div className="h-48 bg-gray-200 relative">
                            {/* Placeholders for resource image */}
                            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-teal-50 to-indigo-50">
                              {resource.category === "FODMAP Guide" && (
                                <BookOpen className="h-16 w-16 text-teal-400" />
                              )}
                              {resource.category === "Elimination Phase" && (
                                <Filter className="h-16 w-16 text-purple-400" />
                              )}
                              {resource.category === "Reintroduction" && (
                                <Check className="h-16 w-16 text-green-400" />
                              )}
                              {resource.category === "Meal Planning" && (
                                <Calendar className="h-16 w-16 text-amber-400" />
                              )}
                              {resource.category === "Printables" && (
                                <FileDigit className="h-16 w-16 text-red-400" />
                              )}
                            </div>
